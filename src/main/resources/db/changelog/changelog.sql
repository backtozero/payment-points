...
CREATE TABLE sales_history (event_timestamp timestamp(3) PRIMARY KEY, request_timestamp timestamp(3), customer_id varchar(255), payment_method_name varchar(255) REFERENCES payment_methods,  final_price decimal, points_earned decimal, additional_item text);
